...
const Home = () => {
  ...
  return (
    <>
      ...
      <section className="text-white animate-duration-slower animate-fade-in-right p-4 h-[250px] flex flex-col mx-2  z-10 justify-end items-center">
      ...
      <section className="w-[90dvw] mx-[5dvw] bg-transparent h-[50dvh] flex justify-between items-end opacity-80 animate-slide-in-top">
        <div className="w-1 h-[30dvh] bg-purple-600 shadowPurple" />
        <div className="w-1 bg-green-500 h-[40dvh] shadowGreen" />
        <div className="w-1 bg-pink-700 h-[20dvh] shadowPink" />
        <div className="w-1 bg-blue-500 h-[10dvh] shadowBlue" />
        <div className="w-1 bg-blue-500 h-[10dvh] shadowBlue" />
        <div className="w-1 bg-pink-700 h-[20dvh] shadowPink" />
        <div className="w-1 bg-green-500 h-[40dvh] shadowGreen" />
        <div className="w-1 h-[30dvh] bg-purple-600 shadowPurple" />

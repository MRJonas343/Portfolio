...
const Home = () => {
  ...
  const [textBlueClassName, setTextBlueClassName] = useState("text-3xl text-blue-500 textShadow")
  const [textGreenClassName, setTextGreenClassName] = useState("text-3xl text-green-500 textShadow")
  const [textPurple, setTextPurple] = useState("text-4xl pt-1 text-purple-700 textShadow")
  ...
  useEffect(() => {
    setInterval(() => {
      ...
      setTextBlueClassName("text-3xl text-blue-500 textShadowBright")
      setTextGreenClassName("text-3xl text-green-500 textShadowBright")
      setTextPurple("text-4xl pt-1 text-purple-700 textShadowBright")
    ...
    setInterval(() => {
      ...
      setTextBlueClassName("text-3xl text-blue-500 textShadow")
      setTextGreenClassName("text-3xl text-green-500 textShadow")
      setTextPurple("text-4xl pt-1 text-purple-700 textShadow")
